...
# <LFerrier>,<11.22.2022>,Modified code to complete assignment 06
# ---------------------------------------------------------------------------- #
...
class IO:
    ...
    def input_new_task_and_priority():
        ...
        print("Task stored! Current Data in table:")
...
while (True):
    ...
    if choice_str.strip() == '1':  # Add a new Task
        ...
        table_lst = Processor.remove_data_from_list(task_to_remove=task, list_of_rows=table_lst)
        continue  # to show the menu
